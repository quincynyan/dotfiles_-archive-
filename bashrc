...
export XDG_CONFIG_HOME="/home/quinc/.config"
export PATH=$PATH:~/.local/bin

# Random commands to greet me in a terminal
#myfetch
...
alias edex="/home/quinc/Downloads/eDEX-UI-Linux-x86_64.AppImage"

alias update="sudo apt update && sudo apt upgrade && sudo apt-get update && sudo apt-get upgrade"
